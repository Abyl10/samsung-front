  ...
  return (
    <div className="min-h-screen bg-[#242C36] flex flex-col items-center overflow-hidden">
      ...
      <div className="flex flex-col max-w-[600px] -mt-20 text-center">
        <h1 className="font-medieval capitalize text-6xl text-[#E9ECEC] mb-8">
          Start Reading With Us
        </h1>
        <p className="font-ubuntu text-base font-light capitalize text-[#ffffff] mb-10">
        ...
        <div className="flex flex-row items-center relative">
          <input
            ...
            className="h-20 w-full rounded-[70px] pl-8 bg-[#EAF0D6] text-[#695846] text-xl"
            placeholder={step === 1 ? 'Enter your email' : 'Enter your code'}
            onKeyDown={onKeyPress}
          />
          <button
            className="rounded-[70px] h-20 bg-[#D99362] w-[100px] absolute right-0"
